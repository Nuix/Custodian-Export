...
class CustodianProduction < NxExporter
  ...
  # @param settings_json [String] path to settings JSON
  def initialize(export_dir, items, settings_json)
  ...
  def populate_pdf(items)
    ...
    @@dialog.logMessage("Using #{temp_dir}")
